...
public class SOSNotificationFragment extends BaseFragment<INotificationViewModel> {
    ...
    protected void initView(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new SOSAdapter(getActivity(), new ArrayList<Notification>(), Constant.NOTIFY_SOS);
