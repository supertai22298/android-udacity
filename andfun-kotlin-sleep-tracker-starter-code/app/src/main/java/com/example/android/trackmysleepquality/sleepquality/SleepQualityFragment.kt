...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModelFactory = SleepQualityViewModelFactory(args.sleepNightKey, dataSource, application)
        ...
        sleepQualityViewModel.navigateToSleepTracker.observe(this, Observer { done ->
            if (done == true)
                let {
